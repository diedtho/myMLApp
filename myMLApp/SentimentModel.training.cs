    ...
    public partial class SentimentModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(@"col0", @"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(l1Regularization:1.10368438684758F,l2Regularization:0.141135824622063F,labelColumnName:@"col1",featureColumnName:@"Features"))      
